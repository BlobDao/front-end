...
import LendAndBorrow from "src/views/LendAndBorrow";
    ...
    return (
        <ViewBase>
            <div className="landing-background">
                <div className="landing-background-blobs-top">{/* <img alt="" src={BlobsTop} /> */}</div>
            ...
            <Switch>
                ...
                {/* <Route exact path="/">
                    <Redirect to="/lendAndBorrow" />
                </Route>

                <Route path="/lendAndBorrow">
                    <LendAndBorrow />
                </Route> */}
