...
import WonderlandIcon from "../../../assets/icons/blob.png";
...
import BlobIcon from "../../../assets/icons/whiteicon.png";
    ...
    return (
        <div className="dapp-sidebar">
            <div className="branding-header">
                {/* <Blober /> */}
                <Link href="https://blobdao.finance" target="_blank">
                    <img alt="" src={BlobIcon} />
                </Link>
            ...
            <div className="dapp-menu-links">
                <div className="dapp-nav">
                    ...
                    <Link
                        ...
                        to="/lendAndBorrow"
                        isActive={(match: any, location: any) => {
                            return checkPage(location, "lendAndBorrow");
                        }}
                        className={classnames("button-dapp-menu", { active: isActive })}
                    >
                        <div className="dapp-menu-item">
                    ...
                    {/* <Link
                        ...
                        to="/docs"
                        isActive={(match: any, location: any) => {
                            return checkPage(location, "docs");
                        }}
                        className={classnames("button-dapp-menu", { active: isActive })}
                    >
                        <div className="dapp-menu-item">
