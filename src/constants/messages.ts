export const messages = {
    please_connect: "Please connect your wallet to the Matic network to use The Blob.",
    please_connect_wallet: "Please connect your wallet.",
    try_mint_more: (value: string) => `You're trying to mint more than the maximum payout available! The maximum mint payout is ${value} BLOB.`,
    ...
    switch_to_matic: "Switch to the Fantom Opera Mainnet?",
