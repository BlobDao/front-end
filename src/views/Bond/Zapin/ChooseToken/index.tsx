...
import { mim as mimToken, wmatic as wmaticToken } from "../../../../helpers/tokens";
...
function ChooseToken({ open, handleClose, handleSelect, bond }: IChooseTokenProps) {
    ...
    const filtredTokens = tokens.filter(({ name, address, isMatic }) => {
        ...
        if (bond.name === wmatic.name) {
            lpFilter = isMatic ? false : wmaticToken.address !== address;
        }
