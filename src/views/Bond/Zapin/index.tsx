...
import { matic, mim } from "../../../helpers/tokens";
...
import { wmatic } from "../../../helpers/bond";
...
function Zapin({ open, handleClose, bond }: IZapinProps) {
    ...
    let defaultToken = tokens.find(token => token.name === matic.name);

    if (bond.name === wmatic.name) {
    ...
    const setMax = () => {
        ...
        let amount: any = Math.min(maxBondPriceToken, token.isMatic ? token.balance * 0.99 : token.balance);
                    ...
                    <div className="zapin-header">
                        ...
                        {!hasAllowance() && !token.isMatic && (
                            <div className="zapin-header-help-text">
                                <p>Note: The "Approve" transaction is only needed when bonding for the first blob</p>
                    ...
                    <div className="zapin-body">
                        ...
                        <div className="zapin-body-params">
                            ...
                            <div className="data-row">
                                ...
                                <p className="data-row-value">{isLoading ? <Skeleton width="100px" /> : `~ ${trim(bond.bondQuote, 4)} BLOB`}</p>
                            </div>
                            <div className="data-row">
                                <p className="data-row-name">Max You Can Buy</p>
                                <p className="data-row-value">{isLoading ? <Skeleton width="100px" /> : `${trim(bond.maxBondPrice, 4)} BLOB`}</p>
                            </div>
                            <div className="data-row">
                            ...
                            <div className="data-row">
                                ...
                                <p className="data-row-value">0.01 BLOB</p>
                            </div>
